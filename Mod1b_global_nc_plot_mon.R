...
#yr_range <- '320001-329912'
  ...
  for (model in model_ls) {
    ...
    for (variab in var_ls) {
      ...
      # Here we do not mask ocean, ice or land.
...
# -------------------------------------------------------      
      ...
      for (mon in mon_ls) {
        ...
        # MAP 1: ANOMALIES
        cairo_pdf(
          paste(plotpath, 'mod_anom_maps/global_LGM_PI_Anom_', model, '_', variab, '_', mon, '.pdf', sep = ""),width = 11.69,
        ...
        # MAP 2: LGM
        cairo_pdf(
          paste(plotpath, 'mod_LGM_maps/global_LGM_data_', model, '_', variab, '_', mon, '.pdf', sep = ""),width = 11.69,
        height = 8.27, onefile = T)
        ...
        # MAP 3: PI
        cairo_pdf(
          paste(plotpath, 'mod_PI_maps/global_PI_data_', model, '_', variab, '_', mon, '.pdf', sep = ""),width = 11.69,
          height = 8.27, onefile = T)
